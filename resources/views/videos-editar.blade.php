            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Editar vídeo</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <form action="/videos/editar/{{$video->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="texto" name="texto" rows="7" required>{!!$video->texto!!}</textarea>  
                                    </div>
                                    <div class="form-group">
